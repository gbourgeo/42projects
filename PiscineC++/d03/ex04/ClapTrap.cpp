...
//   Updated: 2018/07/03 22:34:06 by root             ###   ########.fr       //
//                                                                            //
// ************************************************************************** //
...
ClapTrap::ClapTrap() :  _hit(0), _maxHit(0), _energy(0), _maxEnergy(0), _level(0),
					  _name("CL4P-TP"), _meleeDamage(0), _rangedDamage(0), _armor(0)
{
	std::cout << "A new CL4P-TP is born !" << std::endl;
}

ClapTrap::ClapTrap(std::string &name): _hit(0), _maxHit(0), _energy(0), _maxEnergy(0), _level(0),
					  _name(name), _meleeDamage(0), _rangedDamage(0), _armor(0)
{
